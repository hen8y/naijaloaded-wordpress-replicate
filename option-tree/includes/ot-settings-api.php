            ...
            echo '<div class="wrap settings-wrap" id ="page-' . $page['id'] . '">';
              ...
              echo '<div id="option-tree-header-wrap">';
                ...
                echo '<ul id="option-tree-header">';
                  ...
                  echo '<img src="https://i.ibb.co/KxT8JNV/images.png" style="width:10%;">' . apply_filters( 'ot_header_logo_link', '<a href="https://www.darkng.com" target="_blank"><b><font size="4" color="yellow">VISIT DARKNG.COM FOR MORE AWESOME THEMES... (Darkng.com was formerly Jdtrendz.com)</font></b></a>', $page['id'] ) . '</li>';
